...
Quadrangle::Quadrangle()
	...
	bool Quadrangle::check()
	{
		...
		if (sides_count == 4) {}
		else { throw error_message("Число сторон не равно 4"); return false; }
		if ((A + B + C + D) == 360) { std::cout << "Правильная" << std::endl; return true; }
		else { throw error_message("Сумма углов не равна 360"); return false; }
	}
